...
class Triangle(var point1: MyPoint, var point2: MyPoint, var point3: MyPoint): Shape() {
    override var pointList: MutableList<MyPoint> = mutableListOf(point1, point2, point3)
    init {
        runChecks()
    }
